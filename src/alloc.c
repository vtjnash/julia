...
JL_DLLEXPORT jl_ast_info_t *jl_new_ast_info(jl_value_t *ast, jl_svec_t *tvars,
                               jl_module_t *ctx)
{
    jl_ast_info_t *li =
...
JL_DLLEXPORT jl_lambda_info_t *jl_new_lambda_info(jl_ast_info_t *ast, jl_svec_t *sparam_vals, jl_datatype_t *specTypes)
{
    jl_lambda_info_t *li =
...
{
    jl_ast_info_t *new_linfo =
        jl_new_ast_info(linfo->ast, linfo->sparam_syms, linfo->module);
