...
JL_DLLEXPORT void *jl_get_llvmf_defn2(jl_method_instance_t *linfo, jl_code_info_t *src, size_t world, char getwrapper, char optimize, const jl_cgparams_t params) UNAVAILABLE
JL_DLLEXPORT const jl_value_t *jl_dump_llvm_ir(void *f, uint8_t strip_ir_metadata, uint8_t dump_module) UNAVAILABLE
JL_DLLEXPORT const jl_value_t *jl_dump_llvm_asm(void *f, const char *asm_variant, int optlevel) UNAVAILABLE
