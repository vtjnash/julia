...
jl_value_t *jl_check_binding_assign_value(jl_binding_t *b JL_PROPAGATES_ROOT, jl_binding_partition_t *bpart, uint16_t guard_mask,
                                          ...
                                          jl_binding_partition_t **validated_bpart) JL_CANSAFEPOINT;
...
void jl_retype_flag_partitions(jl_binding_t *b, jl_value_t *slot_ty,
                               jl_value_t *store_ty) JL_CANSAFEPOINT; // requires world_counter_lock
...
STATIC_INLINE int jl_binding_begin_commit(jl_binding_partition_t *bpart, uint16_t mask) JL_NOTSAFEPOINT
{
...
STATIC_INLINE void jl_binding_end_commit(void) JL_NOTSAFEPOINT
{
    jl_ptls_t ptls = jl_current_task->ptls;
...
STATIC_INLINE int jl_binding_try_swap(jl_binding_t *b, jl_binding_partition_t *bpart,
                                      jl_value_t *rhs, jl_value_t **oldp) JL_NOTSAFEPOINT
{
...
STATIC_INLINE int jl_binding_try_cmpswap(jl_binding_t *b, jl_binding_partition_t *bpart,
                                         ...
                                         int *successp, uint16_t guard_mask) JL_NOTSAFEPOINT
{
...
JL_DLLEXPORT void jl_declare_global(jl_module_t *m, jl_value_t *arg, jl_value_t *set_type, int strong, jl_value_t *newval JL_MAYBE_UNROOTED) JL_CANSAFEPOINT;
