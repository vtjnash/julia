...
function reinit_stdio()
    ...
    global STDIN = init_stdio(0, ccall(:jl_stdin_stream, Ptr{Void}, ()))
    global STDOUT = init_stdio(1, ccall(:jl_stdout_stream, Ptr{Void}, ()))
    global STDERR = init_stdio(2, ccall(:jl_stderr_stream, Ptr{Void}, ()))
end
