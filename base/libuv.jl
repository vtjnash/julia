...
function init_libuv()
    global uv_jl_alloc_buf     = ccall(:jl_function_ptr, Ptr{Void}, (Any, Any, Any), uv_alloc_buf, Void, (Ptr{Void}, Csize_t, Ptr{Void}))
    global uv_jl_readcb        = ccall(:jl_function_ptr, Ptr{Void}, (Any, Any, Any), uv_readcb, Void, (Ptr{Void}, Cssize_t, Ptr{Void}))
    global uv_jl_connectioncb  = ccall(:jl_function_ptr, Ptr{Void}, (Any, Any, Any), uv_connectioncb, Void, (Ptr{Void}, Cint))
    global uv_jl_connectcb     = ccall(:jl_function_ptr, Ptr{Void}, (Any, Any, Any), uv_connectcb, Void, (Ptr{Void}, Cint))
    global uv_jl_writecb_task  = ccall(:jl_function_ptr, Ptr{Void}, (Any, Any, Any), uv_writecb_task, Void, (Ptr{Void}, Cint))
    global uv_jl_getaddrinfocb = ccall(:jl_function_ptr, Ptr{Void}, (Any, Any, Any), uv_getaddrinfocb, Void, (Ptr{Void},Cint,Ptr{Void}))
    global uv_jl_recvcb        = ccall(:jl_function_ptr, Ptr{Void}, (Any, Any, Any), uv_recvcb, Void, (Ptr{Void}, Cssize_t, Ptr{Void}, Ptr{Void}, Cuint))
    global uv_jl_sendcb        = ccall(:jl_function_ptr, Ptr{Void}, (Any, Any, Any), uv_sendcb, Void, (Ptr{Void}, Cint))
    global uv_jl_return_spawn  = ccall(:jl_function_ptr, Ptr{Void}, (Any, Any, Any), uv_return_spawn, Void, (Ptr{Void}, Int64, Int32))
    global uv_jl_asynccb       = ccall(:jl_function_ptr, Ptr{Void}, (Any, Any, Any), uv_asynccb, Void, (Ptr{Void},))
    global uv_jl_timercb       = ccall(:jl_function_ptr, Ptr{Void}, (Any, Any, Any), uv_timercb, Void, (Ptr{Void},))
end
