...
function typeinf_ext(linfo::LambdaInfo, atypes::ANY, def::ASTInfo)
...
typeinf(linfo::LambdaInfo,atypes::ANY,sparams::ANY) = typeinf(linfo,atypes,sparams,linfo,true,false)
typeinf(linfo::LambdaInfo,atypes::ANY,sparams::ANY,def::ASTInfo) = typeinf(linfo,atypes,sparams,def,true,false)
...
function typeinf(linfo::LambdaInfo, atypes::ANY, sparams::SimpleVector, def::ASTInfo, cop, needtree)
...
function typeinf_uncached(linfo::LambdaInfo, atypes::ANY, sparams::SimpleVector, def::ASTInfo, curtype, cop, optimize)
    ast0 = def.ast
    #if dbg
